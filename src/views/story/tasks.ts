...
export const tasks: RoadmapTask[] = [
  ...
  },
  {
    ...
    date: DateTime.fromObject({ year: 2021, month: 12, day: 22 }).toJSDate(),
    done: false,
    link: 'https://github.com/NEAR-Edu/stats.gallery/issues/37',
  },
  {
    name: 'Dapp integrations',
    date: DateTime.fromObject({ year: 2021, month: 12, day: 21 }).toJSDate(),
    done: false,
  ...
  {
    name: 'NEAR Login',
    date: DateTime.fromObject({ year: 2021, month: 11, day: 30 }).toJSDate(),
    done: false,
    link: 'https://github.com/NEAR-Edu/stats.gallery/issues/47',
  },
  {
    name: 'New charts',
    date: DateTime.fromObject({ year: 2021, month: 11, day: 29 }).toJSDate(),
    done: false,
    link: '',
  },
  {
